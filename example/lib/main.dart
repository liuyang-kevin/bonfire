...
void main() async {
  ...
  await LESourceManager.screenUtils.setLandscape(); //TODO Comment when running for web
  await LESourceManager.screenUtils.fullScreen(); //TODO Comment when running for web
  runApp(
    MaterialApp(
      home: Menu(),
    ),
